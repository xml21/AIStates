...
namespace LyraGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_ChangeBuilding, "InputTag.ChangeBuilding", "Building change input.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Build, "InputTag.Build", "Building mode toggle input.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_PlaceBuilding, "InputTag.PlaceBuilding", "Building placement input.");
